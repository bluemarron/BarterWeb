        ...
        <div class='container-fluid' style='padding-top:6px;'>
          ...
          <div class='nav-collapse collapse'>
            ...
            <ul class='nav'>
              ...
              <li <?if(!strncmp($path, 'item', strlen('item'))){?>class='active'<?}?>><a href='../item/manage'>상품관리</a></li>
              <li <?if(!strncmp($path, 'trade', strlen('trade'))){?>class='_active'<?}?>><a href='../trade/request_list'>거래신청</a></li>
