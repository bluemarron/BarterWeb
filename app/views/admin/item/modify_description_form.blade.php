...
@section('content')
	...
	<script type="text/javascript">
    	$(document).ready(function () { $("#default_item_description").cleditor(); });
  	</script>
	<script>
		var message = '<?=$message?>';
	...
	<input type='hidden' id='management_id' name='management_id' value='<?=$management->id?>'>
	...
	<div class='well'>
   		<p>
			<fieldset>
				...
				<ul>
					<li> 
					    <textarea rows='12' id='default_item_description' name='default_item_description' class='span12' placeholder='설명을 입력하세요.'><?=$management->default_item_description?></textarea>
